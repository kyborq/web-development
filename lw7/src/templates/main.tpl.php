  ...
  <body>
    ...
    <div class="content">
      ...
      <div class="content__side side">
        <img src="img/picture.png" alt="" class="content__picture" />
      ...
      <div class="section__content">
        ...
        <div class="movies">
          <div class="movies__item movie">
            <img src="img/film_showshenk.png" alt="" class="movie__image" />
          ...
          <div class="movies__item movie">
            <img src="img/film_narcos.png" alt="" class="movie__image" />
          ...
          <div class="movies__item movie">
            <img src="img/film_astral.png" alt="" class="movie__image" />
          ...
          <div class="movies__item movie">
            <img src="img/film_gravity.png" alt="" class="movie__image" />
        ...
        <form class="form" method="POST">
          <div class="form__field field">
            ...
            <? if (isset($args['name_error_msg'])): ?>
              <span class="error-message"><? echo $args['name_error_msg'] ?></span>
            <? endif; ?>
          </div>
          <div class="form__field field">
            ...
            <? if (isset($args['email_error_msg'])): ?>
              <span class="error-message"><? echo $args['email_error_msg'] ?></span>
            <? endif; ?>
          </div>
          
          <div class="form__field field">
            <label for="country" class="field__label">Откуда вы?</label>
            <select name="country" class="field__input field__select">
          ...
          <div class="form__field field form__radio">
            ...
            <div class="radio-box">
              <input type="radio" id="gender_male" name="gender" value="Мужской" class="radio-box__item" />
          ...
          <div class="form__field field">
            ...
            <textarea id="your-message" class="field__input field__input_multiline" value="<? echo $args['message'] ?? ''; ?>"></textarea>
            <? if (isset($args['message_error_msg'])): ?>
              <span class="error-message"><? echo $args['message_error_msg'] ?></span>
            <? endif; ?>
          </div>
